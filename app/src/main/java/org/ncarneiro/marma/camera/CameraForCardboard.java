package org.ncarneiro.marma.camera;
...
/**
 * Created by Nikolas on 9/10/2015.
 */
public class CameraForCardboard implements SurfaceTexture.OnFrameAvailableListener {

    private Activity activity;

    private static final String TAG = "CameraForCardboard";
...
//        0.0f,  0.0f
     ...
     * to render our scene.
     */
    public CameraForCardboard(Activity a, CardboardView cardboardView) {
        this.activity = a;
        this.cardboardView = cardboardView;
        mCamera = new float[16];
        mView = new float[16];
        mOverlayView = (CardboardOverlayView) activity.findViewById(R.id.cardboard_overlay);
...
//        checkGLError("onReadyToDraw");
     ...
     */
    public void drawEye(Eye transform) {
        GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT | GLES20.GL_DEPTH_BUFFER_BIT);
